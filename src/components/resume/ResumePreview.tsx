import { MapPin, Phone, Mail, Github, Linkedin, Globe, User } from "lucide-react";
import { templatePreviewStyles } from "./resumeTemplates";
...
const ResumePreview = ({ content, templateKey }: ResumePreviewProps) => {
  ...
  return (
    <div className="bg-white text-gray-900 rounded-lg shadow-inner overflow-hidden">
          ...
          <div className="mb-4">
            ...
            <div className="space-y-1.5">
              ...
              {profile?.portfolio_url && (
                <div className="flex items-center gap-1.5 text-[10px]">
                  <Globe className={`w-3 h-3 flex-shrink-0 ${style.accentColor}`} />
                  <span>Portfolio</span>
                </div>
              )}
            </div>
